...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685' => 'get17eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685Service',
            '2_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685' => 'get27eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685Service',
        ...
        $this->privates = array(
            '1_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685' => true,
            '2_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685']) ? $this->services['1_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685'] : $this->get17eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685']) ? $this->services['2_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685'] : $this->get27eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'dbname' => 'flyaround', 'user' => 'root', 'password' => 'sese890510', 'charset' => 'UTF8', 'port' => NULL, 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/WCS/CoavBundle/Entity'))), 'WCS\\CoavBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('WCSCoavBundle' => 'WCS\\CoavBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_d62bff9710cab39139fbe22a0e9b19ac246655c015869838e45593e270fe26ad');
    ...
    protected function getForm_RegistryService()
    {
        ...
        }, 'WCS\\CoavBundle\\Form\\RegistrationType' => function () {
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('WCS\\CoavBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer(${($_ = isset($this->services['swiftmailer.mailer.default']) ? $this->services['swiftmailer.mailer.default'] : $this->get('swiftmailer.mailer.default')) && false ?: '_'}, ${($_ = isset($this->services['router']) ? $this->services['router'] : $this->get('router')) && false ?: '_'}, ${($_ = isset($this->services['templating']) ? $this->services['templating'] : $this->get('templating')) && false ?: '_'}, array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('julia.sese@wanadoo.fr' => 'julia.sese@wanadoo.fr'), 'resetting' => array('julia.sese@wanadoo.fr' => 'julia.sese@wanadoo.fr'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('WCS\\CoavBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory(${($_ = isset($this->services['form.factory']) ? $this->services['form.factory'] : $this->get('form.factory')) && false ?: '_'}, 'fos_user_registration_form', 'WCS\\CoavBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('WCS\\CoavBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('WCS\\CoavBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/planemodel');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/flight');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/reservation');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/terrain');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/review');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$');
        ...
        $q->add($h, array(0 => 'ROLE_USER'), NULL);
        $q->add($i, array(0 => 'ROLE_USER'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('julia.sese@wanadoo.fr');
        $a->setPassword('wmneutyt5');
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/WCS/CoavBundle/Resources/views'), 'WCSCoav');
    ...
    /**
     * Gets the private '1_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get17eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685Service()
    {
        return $this->services['1_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get27eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685Service()
    {
        return $this->services['2_7eac8b9bccd2aff1fe3e71a0106a9a1e666069d6c067b472c4652ee59a796685'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
     ...
     *
     * @return \WCS\CoavBundle\Form\RegistrationType
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \WCS\CoavBundle\Form\RegistrationType();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('PixJvixYFN', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XV-xv31VAq', 0, 'yZHTujWG6ha1yska4zfrox', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kzh0KqQVCO', 0, 'yZHTujWG6ha1yska4zfrox', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OAY948WFFv', 0, 'yZHTujWG6ha1yska4zfrox', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a60bea3996d79.67989567');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'WCSCoavBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/WCS/CoavBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WCSCoavBundle' => 'WCS\\CoavBundle\\WCSCoavBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'sese890510',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'julia.sese@wanadoo.fr',
            'mailer_password' => 'wmneutyt5',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'julia.sese@wanadoo.fr',
            'swiftmailer.mailer.default.transport.smtp.password' => 'wmneutyt5',
            ...
            'fos_user.model.user.class' => 'WCS\\CoavBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'julia.sese@wanadoo.fr' => 'julia.sese@wanadoo.fr',
            ),
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'WCS\\CoavBundle\\Form\\RegistrationType',
