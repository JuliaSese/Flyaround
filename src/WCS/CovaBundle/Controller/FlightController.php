...
use WCS\CovaBundle\Entity\Flight;
...
class FlightController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $flights = $em->getRepository('WCSCovaBundle:Flight')->findAll();
    ...
    {
        $flight = new Flight();
        $form = $this->createForm('WCS\CovaBundle\Form\FlightType', $flight);
    ...
    {
        $deleteForm = $this->createDeleteForm($flight);
        $editForm = $this->createForm('WCS\CovaBundle\Form\FlightType', $flight);
