...
use WCS\CovaBundle\Entity\PlaneModel;
...
class PlaneModelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $planeModels = $em->getRepository('WCSCovaBundle:PlaneModel')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('WCS\CovaBundle\Form\PlaneModelType', $planeModel);
    ...
    {
        $deleteForm = $this->createDeleteForm($planeModel);
        $editForm = $this->createForm('WCS\CovaBundle\Form\PlaneModelType', $planeModel);
